...
async function P(e) {
  const { templateId: t, code: i, name: r, basePath: o, description: m, variables: c } = e, a = g(t);
  if (!a)
    return {
      success: !1,
      error: `Template not found: ${t}`
    };
  try {
    const n = {
      code: i,
      name: r,
      basePath: o,
      description: m || d(a.description, c),
      steps: a.steps.map((p) => ({
        title: d(p.title, c),
        description: d(p.description, c)
      }))
    };
    return {
      success: !0,
    ...
    return {
      success: !1,
      error: n instanceof Error ? n.message : "Unknown error applying template"
    };
  }
}
function d(e, t) {
...
const f = {
  id: "basic",
  name: "Basic Plan",
  description: "A simple plan template with minimal structure. Good for quick tasks or custom workflows.",
  category: "general",
  ...
  description: "Plan template for developing new features. Covers analysis, design, implementation, testing, and deployment.",
  ...
  description: "Plan template for code refactoring. Emphasizes safety, incremental changes, and thorough testing.",
  category: "development",
  ...
  id: "migration",
  name: "Migration Plan",
  description: "Plan template for migrations (data, system, platform). Emphasizes safety, rollback capability, and thorough validation.",
  category: "operations",
  ...
  id: "sprint",
  name: "Sprint Plan",
  description: "Plan template for agile sprints or iterations. Covers planning, daily execution, review, and retrospective.",
  category: "general",
...
export {
  f as BasicTemplate,
  h as FeatureTemplate,
  k as MigrationTemplate,
  y as RefactoringTemplate,
  v as SprintTemplate,
  l as TEMPLATE_REGISTRY,
  A as VERSION,
  P as applyTemplate,
  g as getTemplate,
  b as listTemplates
